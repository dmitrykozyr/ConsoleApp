...
public class LoggingService : ILoggingService
{
    ...
    public LoggingService(IOptions<GeneralOptions> generalOptions, IDbConStrService dbConStrService)
    {
    ...
    public Task LogToFile(LoggingTypes loggingType, string message)
    {
        ...
        lf.WriteLine("----------------------------------------------------------------");
        lf.WriteLine($"{DateFormatters.DateTimeNow()}: {loggingType}, {message}");
        lf.Flush();
        lf.Close();
    ...
    public Task LogToDB(RestMethods operationType, string bucketPath, Guid guid)
    {
        Guard.IsNotNull(GeneralOptions);
    ...
    public Task LogToConsole(string message)
    {
