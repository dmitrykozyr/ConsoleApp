...
namespace SharpEdu
{
    public class AsyncAwait
    {
        ...
        #region Асинхронные комбинаторы
        class AsyncCombinators_
        {
            // Асинхронные комбинаторы - это методы, позволяющие комбинировать асинхронные операции
            // Позволяют совместно использовать результаты нескольких асинхронных операций,
        ...
        #region Асинхронный итератор

        class AsyncEnumerable_
        {
