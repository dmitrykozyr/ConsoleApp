...
{
    public void VisitLion(Lion lion) => Console.WriteLine($"Лев рычит: {lion.Roar()}");

    public void VisitMonkey(Monkey monkey) => Console.WriteLine($"Обезьяна кричит: {monkey.Shout()}");
}
