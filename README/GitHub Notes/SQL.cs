	...
	*/
	...
	/*
		...
		- Snapshot			- если две транзакции совершаются параллельно, то каждой из них выдают свой слепок БД
							  После выполнения всех операций со слепком (удаление/запись/изменение/чтение),
							  изменения вливаются в основную версию БД
							  ...
							  Если изменялись одни и те же данные - можем получить аномалию
	*/
	#endregion
