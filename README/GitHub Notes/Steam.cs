...
В sdk\tools\ContentBuilder\content создаем папки Windows и Linux, кидаем туда соответствующие билды
В sdk\tools\ContentBuilder\scripts есть два текстовых файла
...
В sdk\tools\ContentBuilder\builder запустить steamcmd и ввести login [логин], [пароль], [код], присланный на почту
Вводим run_app_build E:\sdk\tools\ContentBuilder\scripts\app_build_742470.vdf

//======================== Steamworks ============================
Изменить настройки приложения -> SteamPipe -> Сборки устанавливаем последнюю сборку как default
