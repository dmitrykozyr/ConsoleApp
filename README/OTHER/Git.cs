    ...
    #region Разница между merge и rebase
        ...
        /*
            1.Структура истории
                ...
                Если есть ветка feature и вы сливаете ее в main, то будет создан новый коммит, который объединяет обе ветки
            ...
            2. Использование
                ...
                Git Rebase часто используется для "чистки" истории перед слиянием, чтобы сделать ее более линейной и понятной
