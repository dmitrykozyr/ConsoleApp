/*
    MongoDB — это документно-ориентированная NoSQL БД, которая хранит данные в формате BSON (Binary JSON)
    Обеспецивает:
    - высокую производительность
    - масштабируемость
    - гибкость при работе с большими объемами данных

    - данные хранятся в виде документов, которые представляют собой структуры, подобные JSON - это позволяет хранить сложные и вложенные структуры данных
    ...
    - предоставляет мощный язык запросов, который позволяет выполнять сложные операции, такие как фильтрация, агрегация и сортировка данных
    - поддерживает репликацию - позволяет создавать копии данных на нескольких серверах
    - позволяет выполнять сложные вычисления и преобразования данных на уровне БД

    Особенно полезна, когда структура данных может изменяться или необходимо работать с большими объемами информации 
 */
