public class A
{
	...
	SOAP
		...
		- Fault - содержит информацию об ошибках, произошидших при обработке сообщения

	JSON-RPC
		Спецификация, как как представлять запросы и ответы на странице в формате JSON
